...
1. Spécifier les composants d'une strate
1. Modifier `dir_regexp` pour les fichiers de production
...
Des répertoires seront créés par produit-unité-strate. Pour définir les strates d'intérêt de l'enquête, fournir une vecteur de nom de variables qui, ensemblent, forment les strates de l'échantillon NSU.

En de termes concrets, modifier la valeur de la variable `variables_strate`. L'exemple ici-bas montre le cas, assez fréquent, de strates composés par la région (`s00q01`) et le milieu (`s00q04`).
